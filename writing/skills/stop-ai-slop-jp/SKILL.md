...
description: "AIで書いた日本語を人間が書いた文章に戻す。下書き・編集・レビューで、全角ダッシュや偏愛語だけでなく、主体の不在・命題型H2・壮大化・両論併記・リズムの均一さも直す。英語の文章には /writing:stop-ai-slop-en を使う。Triggers: /writing:stop-ai-slop-jp, AI臭を消す, 文章レビュー, この文章を直して, AIっぽさを取る, de-slop 日本語"
user-invocable: true
allowed-tools: Read, Write, Edit
model: sonnet
metadata:
  inspired-by: hardikpandya/stop-slop
  original-author: Daichi Nagashima (https://genshi.ai/)
  source: iKora128/stop-ai-slop-jp
  license: MIT
---
...
> 兄弟スキル: 英語の文章を直すときは `/writing:stop-ai-slop-en` を使う。本スキルは日本語専用。
...
[iKora128/stop-ai-slop-jp](https://github.com/iKora128/stop-ai-slop-jp)(作: Daichi Nagashima)を当マーケットプレイス向けに再編集。原案は [hardikpandya/stop-slop](https://github.com/hardikpandya/stop-slop)。いずれも MIT License。
