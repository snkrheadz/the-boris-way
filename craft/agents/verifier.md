...
2. If no rubric was provided, Read the matching craft standard and use its numbered rules plus
   its verification checklist as the rubric. Look in this order: (a) the `produce` skill's
